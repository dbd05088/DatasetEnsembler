...
def main():
    ...
    parser.add_argument('--print_freq', '-p', default=10, type=int, help='print frequency (default: 20)')
    ...
    for index in subset["indices"]:
        ...
        target_file = selected_file.replace(args.dataset, f"{args.dataset}_{args.model}_{args.selection}_{args.selection_epochs}_{args.selection_lr}")
